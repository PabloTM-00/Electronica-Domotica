...
//	private 	SerialPort 				serialPort;	
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		javax.swing.JComboBox<String> comboModos = new javax.swing.JComboBox<String>();
		comboModos.setBounds(20, 20, 250, 30); 
		
		comboModos.addItem("1. Pulsadores");
		comboModos.addItem("2. Interruptores");
		comboModos.addItem("3. Conmutadores");
		
		panel_1.add(comboModos); 

		comboModos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int seleccion = comboModos.getSelectedIndex();
