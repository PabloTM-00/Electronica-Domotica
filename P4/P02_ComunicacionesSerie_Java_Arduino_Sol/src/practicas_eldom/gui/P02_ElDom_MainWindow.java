...
public class P02_ElDom_MainWindow {
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		JLabel lblSeleccionaApartadoPrctica = new JLabel("Selecciona Apartado de la Práctica 4\r\n");
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					case 3:  
						commSerie.writeStringToSerial("#4");
						break;
					}
		...
		comboBox.setToolTipText("Apartado 2\r\nApartado 3\r\nApartado 4\r\nApartado 5");
		...
		comboBox.setBounds(68, 103, 300, 20); 
