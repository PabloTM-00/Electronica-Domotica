...
public class P02_ElDom_MainWindow {
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		JLabel lblSeleccionaApartadoPrctica = new JLabel("Selecciona Apartado de la Práctica 1\r\n");
		lblSeleccionaApartadoPrctica.setBounds(68, 74, 229, 14);
		panel_1.add(lblSeleccionaApartadoPrctica);
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					case 0:
						commSerie.writeStringToSerial("#1");
						break;

					case 1: // Pulsadores funcionan como interruptores
						commSerie.writeStringToSerial("#2");
						break;

					case 2: // Todos los pulsadores forman parte de un conmutador.
						commSerie.writeStringToSerial("#3");
						break;
					}
		...
		comboBox.setToolTipText("Apartado 1\r\nApartado 2\r\nApartado 3");
		comboBox.setModel(new DefaultComboBoxModel<String>(new String[] {"Apartado 1", "Apartado 2", "Apartado 3"}));
		comboBox.setSelectedIndex(0);
		comboBox.setBounds(68, 103, 106, 20);
