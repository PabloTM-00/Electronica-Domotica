...
extern void Pulsado_Soltado_ModBus(void *Sensor);

void config_practica6(void){
	domoboard.Clear_SensorsConfiguration();
	domoboard.BOTON1.SensorEvent = Pulsado_Soltado_ModBus;
	domoboard.BOTON2.SensorEvent = Pulsado_Soltado_ModBus;
	domoboard.BTN_OPT.SensorEvent = Pulsado_Soltado_ModBus;
}
