	...
	public COMSerie_MainWindow() {		
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				writeCoil(1, MB_Registers.MB_RELE, MB_Registers.TSwitchState.ON);
			}
		});
		btnNewButton.setBounds(79, 80, 144, 23);
		...
		btnOnTriac.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				writeCoil(1, MB_Registers.MB_TRIAC, MB_Registers.TSwitchState.ON);
			}
		});
		btnOnTriac.setBounds(256, 80, 144, 23);
		...
		btnOffTriac.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				writeCoil(1, MB_Registers.MB_TRIAC, MB_Registers.TSwitchState.OFF); 
			}
		});
		btnOffTriac.setBounds(256, 116, 144, 23);
		...
		btnOffRel.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				writeCoil(1, MB_Registers.MB_RELE, MB_Registers.TSwitchState.OFF); 
			}
		});
		btnOffRel.setBounds(79, 116, 144, 23);
		panel_1.add(btnOffRel);
		
	}
	
	private void writeCoil(int SlaveAddress, int ModBusRegister, MB_Registers.TSwitchState coilState) {
		...
		String[] args = {Integer.toString(SlaveAddress), String.valueOf(Const_Modbus.WRITE_COIL), 
				...
				MB_Registers.TSwitchState.ToNumberString(coilState)};		
